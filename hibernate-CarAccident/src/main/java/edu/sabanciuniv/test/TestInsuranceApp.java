...
public class TestInsuranceApp {
    ...
    private static void saveTestData() {
        ...
        //Customer objesi construct ettik
        Customer customer1 = new Customer("İlayda Balik", "Istanbul", 321562365123L, "111111111");
        Customer customer2 = new Customer("Didar Turk", "Ankara", 32132143246L, "2222222222");
        Customer customer3 = new Customer("Ayse Simsek", "Edirne", 6452533241L, "3333333333");

        Vehicle car1 = new Car( 2020, "34VG5677", "Red");
        Vehicle car2 = new Car(2017, "08HG234", "Black");
        Vehicle moto1 = new Motorcycle(2020, "65NN322", 120.0);
        Vehicle moto2 = new Motorcycle(2017, "08TT122", 340.0);
        Vehicle moto3 = new Motorcycle( 2013, "34VG111", 420.0);

        //Araçların müşterilerini setliyorum - araçlar üzerinden müşteriye erişip müşteriyi setlerim
        //customer1.getVehicleList().add(car1)
        ...
        entityManager.persist(car1); //Objelerimi kaydedeceğim
